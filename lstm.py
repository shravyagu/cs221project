...
# LSTM with multiple dense layers after. (LSTMS with additional dense layers just caused more overfitting.)
model = Sequential()
...
plot_model(model, to_file='hist_lstm.png', show_shapes=True, show_layer_names=True)
...
plot_model(model, to_file='diag_lstm.png', show_shapes=True, show_layer_names=True)
...
plot_model(model, to_file='treat_lstm.png', show_shapes=True, show_layer_names=True)
